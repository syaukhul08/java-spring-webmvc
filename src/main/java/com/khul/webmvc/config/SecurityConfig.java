...
import com.khul.webmvc.config.security.CustomAccessDeniedHandler;
import com.khul.webmvc.config.security.CustomAuthenticationFailureHandler;
import com.khul.webmvc.config.security.CustomLogoutSuccessHandler;
import com.khul.webmvc.config.security.CustomUrlAuthenticationSuccessHandler;
...
public class SecurityConfig {
    @Value("${sping.security.debug:false}")
